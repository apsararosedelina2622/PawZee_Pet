    ...
    return (
        <>
            <div className='xl:px-14 lg:px-10 pt-24'>
                ...
                <div className='w-fit mx-auto text-3xl md:text-5xl lg:text-5xl lg:py-10 font-semibold text-transparent bg-clip-text bg-gradient-to-l from-purple-400 to-[#6a70d1] lg:h-[15vh] md:h-[10vh]'>
                    <p>PawZee Shop</p>
                </div>
                        ...
                        <div className="drawer-side">
                            ...
                            <div className="menu bg-white text-base-content shadow-lg rounded-b-lg min-h-full w-80 p-4">
                                <div className='flex justify-between items-center mb-5'>
                                    <button className="text-transparent bg-clip-text bg-gradient-to-r from-[#6a70d1] to-purple-400 font-semibold text-lg" onClick={() => handleFilter('')}>
                                        Clear Filters
                                    </button>
                                ...
                                <div key={index} className="bg-white shadow-lg overflow-hidden group hover:translate-y-[-10px] transition-all duration-300 ease-in-out">
                                    ...
                                    <div className="p-4">
                                        ...
                                        <div className="flex justify-between items-center">
                                            <button className="mt-4 bg-gradient-to-r from-[#6a70d1] to-purple-400 text-white font-medium rounded-lg px-6 py-2 shadow-md transition-all duration-300 hover:bg-gray-100 hover:bg-none hover:text-purple-500 hover:shadow-lg" onClick={() => setSelectedItem(data)}>
                                                Shop Now
                                            </button>

    ...
    return (
        <>
            <div className="px-5 lg:px-20 py-5">
                <div className='w-fit mx-auto h-[56px] text-3xl md:text-5xl lg:text-5xl font-medium text-transparent bg-clip-text bg-gradient-to-r from-[#6a70d1] to-purple-400'>
                    <p>PawZee Family</p>
                </div>
                <div className="flex flex-col lg:flex-row items-center lg:gap-16 py-5">
                    ...
                    <div className="text-center lg:text-start w-full p-5 mt-8 border border-[#6a70d1] rounded-bl-3xl rounded-tr-3xl">
                        ...
                        <p className="block font-semibold text-gray-800 text-end">– Jeookie J.</p>
                    </div>
                </div>

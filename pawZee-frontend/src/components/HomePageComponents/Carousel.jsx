            ...
            <SwiperSlide key={index}>
              <div className="relative md:pt-20 lg:pt-0">
                ...
                <div className="absolute inset-0 flex flex-col justify-center items-start lg:px-16 md:px-12" >
                  <p className="xl:text-6xl lg:text-4xl md:text-3xl font-bold bg-gradient-to-r from-[#6a70d1] to-purple-400 bg-clip-text text-transparent">
            ...
            <SwiperSlide key={index}>
              <div className="relative mt-20">
                ...
                <div className="absolute inset-0 flex flex-col justify-center items-start pl-4">
                  <p className="text-2xl font-bold bg-gradient-to-r from-[#6a70d1] to-purple-400 bg-clip-text text-transparent">
                  ...
                  <Link to={'/shop/cat'}>
                    <button className="btn-sm bg-gradient-to-r from-[#6a70d1] to-purple-400 text-white font-semibold rounded-full">
                      Discover More
                    </button>
                  </Link>
                </div>

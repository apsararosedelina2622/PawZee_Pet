...
const Footer = () => {
    return (
        <>
            <footer className='bg-gray-100 p-5 md:px-14 lg:px-0 shadow-inner'>

                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 lg:px-20 lg:gap-16'>

                    <div className='my-3'>
                        <div>
                            <Link to={'/home'} className="text-3xl font-semibold text-transparent bg-clip-text bg-gradient-to-r from-[#6a70d1] to-purple-400 relative bottom-1 leading-none cursor-pointer">
                                PawZee
                                <span className="absolute w-10 h-8 bg-purple-800 rounded-full bottom-0 -right-2 blur-md opacity-40"></span>
                                <span className="absolute rounded w-16 h-[3px] bg-gradient-to-r from-[#6a70d1] to-purple-400 -bottom-0 left-0 transform -skew-x-10 "></span>
                            </Link>
                        </div>
                ...
                <div className="text-base hidden lg:block md:block text-center mt-10 mb-2 space-y-2">
                    ...
                    <p>Designed and Developed By <a href="mailto:apsararosedelina@gmail.com" className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-[#6a70d1] font-medium hover:underline">Apsara Rose Delina</a></p>
                </div>

                <div className="text-base lg:hidden md:hidden text-center mt-5 space-y-2">
                    <p>&copy; 2025 PawZee. All Rights Reserved.</p>
                    <p>Designed and Developed </p> 
                    <p>By <a href="mailto:apsararosedelina@gmail.com" className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-[#6a70d1] font-medium hover:underline mt-5">Apsara Rose Delina</a></p>
                </div>

        ...
        {showRegister ? (
          ...
          <div className='lg:flex md:flex items-center justify-center border rounded shadow-xl lg:mx-auto mx-5 p-5 xl:w-7/12 lg:w-8/12 bg-white'>
            ...
            <div className='w-full py-5'>
              <h2 className="text-2xl font-semibold text-transparent bg-clip-text bg-gradient-to-r from-[#6a70d1] to-purple-400 mb-5">Register</h2>
          ...
          <div className='lg:flex md:flex items-center justify-center border rounded shadow-xl lg:mx-auto mx-5 p-5 xl:w-7/12 lg:w-8/12 bg-white'>
            ...
            <div className='lg:p-5 w-full'>
              <h2 className="text-2xl font-semibold text-transparent bg-clip-text bg-gradient-to-r from-[#6a70d1] to-purple-400 mb-5">Login</h2>
